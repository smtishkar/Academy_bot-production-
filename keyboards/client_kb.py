...
trainings_kb = ReplyKeyboardMarkup(resize_keyboard=True).add(tech_tr_button,non_tech_tr_button).add(ucar_tr_button,detailed_description_button).add(back_button)
...
# back_schedule_button = KeyboardButton('Назад')
schedule_kb = ReplyKeyboardMarkup(resize_keyboard=True).add(tech_schedule_button,non_tech_schedule_button).add(ucar_schedule_button,back_button)